...
static std::vector<const char*> build_argv(const std::string& command,
...
class PosixProcess : public PlatformProcess {
  ...
  public:
    PosixProcess(pid_t pid, int stdout_fd, int stdin_fd)
        : pid_(pid), stdout_fd_(stdout_fd), stdin_fd_(stdin_fd) {}
