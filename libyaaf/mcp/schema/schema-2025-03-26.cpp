...
class SchemaBackend2025_03_26 final : public Backend
{
  public:
...
std::shared_ptr<const Backend> generated_backend_2025_03_26()
{
    static const auto instance = std::make_shared<SchemaBackend2025_03_26>();
    return instance;
}
} // namespace yaaf::mcp::schema
